...
| `swe/pipeline-design` | Platform-agnostic CI/CD deployment pipeline design and review - stage flow, approval and metric gates, choosing a rollout strategy (rolling/blue-green/canary/feature-flag), safe rollback with backward-compatible migrations, health checks that don't lie, and build-once-promote-the-same-artifact. Applies to any runner and any target; ends with a design-review checklist. |
